...
//
// Compile command:
// g++ -std=c++0x ./MCReg_CC_v1.cpp ../include/current_time.cpp ../include/print.cpp ../include/extract_observed_RC_CC.cpp -o ./MCReg_CC_v1
//============================================================================

//This version is an extension of ~/code/wt/d/MCReg_v2.cpp
...
#include "/home/adrian/code/wt/d/include/current_time.h"
#include "/home/adrian/code/wt/d/include/print.h"
#include "/home/adrian/code/wt/d/include/extract_observed_RC_CC.h"
...
argv[3] - File with mapped observed reads from Bowtie (default output file) \n\
...
int main(int argc,char *argv[]){
	...
	string obsRBowtie_file=argv[3]; //aligned observed reads
...
*************************************************************/
cout<<"\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"<<endl;
cout<<"["<<current_time()<<"] Step3: Extract observed read classes from Bowtie output "<<endl;
cout<<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"<<endl;
	
//obsReadsClasses contains only names and not numbers
int discarded_reads=extract_observed_rc_cc(obsRBowtie_file, obsReadsClasses);
...
string d_file_new2=obsRBowtie_file.substr(0,obsRBowtie_file.find_last_of("/"))+"/d_values.txt";
...
{//Definition for d_values2file: //map<comp, map<RC, map<tr,value> > >
	...
	//To DO: Impromve running time for this sumation(maybe move it together with another loop)
...
*	O-values File	*
*********************/
string o_file_new=obsRBowtie_file.substr(0,obsRBowtie_file.find_last_of("/"))+"/o_values_noCC.txt";
...
*	D-values File	*
*********************/
string d_file_new2=obsRBowtie_file.substr(0,obsRBowtie_file.find_last_of("/"))+"/d_values_noCC.txt";
cout<<"\nWrite d_t,r values to: \n\t"<<d_file_new2<<endl;
