...
// Compile command:
// g++ -std=c++0x ./compute-nextCounts.cpp ../include/current_time.cpp ../include/norm.cpp ../include/normD.cpp ../include/print.cpp ../include/extract_obsRC.cpp ../include/prepro_extract_read_classes_cc.cpp -o ./compute-nextCounts -I /usr/local/include/ -L /usr/local/lib/
//============================================================================
