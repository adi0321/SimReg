...
// Compile command:
// g++ -std=c++0x ./compute-freq-42t.cpp ../include/current_time.cpp ../include/norm.cpp ../include/print.cpp ../include/prepro_extract_read_classes_cc.cpp ../include/load_obsCounts.cpp -o ./compute-freq-42t -I /usr/local/include/ -L /usr/local/lib/
//============================================================================
