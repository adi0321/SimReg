...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//TO DO: 9/3/2014
//start with the id of the last component of the last comp
...
int cmpSizeThresh=2000; //initial number of transcripts that is allowed in one component
int subCmpId=100000;
		...
		//1. Get the read classes for this component and save them in a local variable
			...
			for (const auto &class_ID : rcCounts[cmpID]){
				...
				cmpObsReadsClasses[sortedReadClass]=obsReadsClasses[rcID_reverse[class_ID]];
						...
						#if DEBUG
							cout<<"Print all initial read classes that belong to this component"<<endl;
