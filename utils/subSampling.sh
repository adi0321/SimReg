...
then
	echo ""
	echo -e "Usage: \n"
	echo "argv[1] - Reads File - pair 1.fastq"
	echo "argv[2] - Reads File - pair 2.fastq"
	echo ""
	exit 1
fi

#SubSampling
# For each read - randomly pick one read
gtf=$1
...
do
	...
	#echo "Random = $RANDOM"
	#${SCRIPT_DIR}/scientific_notation_calculator $current_gene_freq $number_of_tr 0 $RANDOM
	#exit 7
